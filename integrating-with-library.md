...
| ProductDefinitionRepository         | Returns a list of product definitions to be used by the API.                                         | `JsonFileProductDefinitionRepository`: Uses a JSON file source for the product definitions.                                                     | Set `dpr.lib.definition.location` to the location of the source file (defaults to `productDefinition.json`, which can be created in the client application).                                                                                                                   |
