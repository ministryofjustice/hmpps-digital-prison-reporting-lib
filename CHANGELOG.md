...
# 9.11.11
- Removed validation of sort column against selected columns in the download endpoint. Sort column is already validated against schema fields and this is redundant as we select all column in the SQL query.  
