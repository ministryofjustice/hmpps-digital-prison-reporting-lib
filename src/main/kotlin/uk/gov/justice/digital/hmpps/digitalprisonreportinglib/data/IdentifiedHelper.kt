...
class IdentifiedHelper {
  final inline fun <reified T : Identified> findOrFail(all: List<T>?, id: String?): T = findOrNull(all, id) ?: throw IllegalArgumentException("Invalid ${T::class.simpleName} ID: ${cleanId(id)}")
